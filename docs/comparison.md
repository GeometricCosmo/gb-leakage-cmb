...
- **Positioning**:  
  gb-leakage-cmb is an *application-layer extension* of CLASS/CAMB, similar in spirit to HiCLASS. It fills a niche for high-ℓ CMB phenomenology and provides reproducible pipelines for immediate paper replication.
